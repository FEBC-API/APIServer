...
router.post('/', [
  ...
  */
  ...
  try{
    ...
    const item = await ConfigModel.create(clientId, req.body);    
...
router.put('/:_id', async function(req, res, next) {
  ...
  */
  try{
    const clientId = getClientId(req);
    const result = await ConfigModel.update(clientId, req.params._id, req.body);
    if(result){
...
router.delete('/:_id', async function(req, res, next) {
  ...
  */
  try{
    const clientId = getClientId(req);
    const result = await ConfigModel.delete(clientId, req.params._id);
