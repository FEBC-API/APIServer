...
router.get('/orders', [
  ...
  */
    ...
    try {
      ...
      switch (by) {
        case 'seller':
          result = await StatisticsModel.ordersBySeller(clientId, search);
          break;
        case 'product':
          result = await StatisticsModel.ordersByProduct(clientId, search);
          break;
        case 'day':
          result = await StatisticsModel.ordersByDay(clientId, search);
          break;
        default:
          result = await StatisticsModel.orders(clientId, search);
          break;
      }
