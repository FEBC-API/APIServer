  ...
  components: {
    securitySchemes: {
      "Access Token": {
        ...
        scheme: 'bearer',
        bearerFormat: 'JWT',
        description: '로그인 후에 전달받은 Access Token'
      },
      "Refresh Token": {
        type: 'http',
        scheme: 'bearer',
    ...
    schemas: {
      ...
      accessTokenRes: {
        ...
        "refreshToken": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJfaWQiOjUsInR5cGUiOiJ1c2VyIiwiaWF0IjoxNzAwNTU1NjUzLCJleHAiOjE3MDA1NTYyNTMsImlzcyI6IkZFU1AwMSJ9.tBbQZLmwlg0y5juJ_TTkET1buZ4QFGf8RJ0G_IWIyns"
      },
      productCreate: {
        "price": 1000,
        "quantity": 600,
